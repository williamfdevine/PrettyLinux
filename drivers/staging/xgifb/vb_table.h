...
const struct XGI_Ext2Struct XGI330_RefIndex[] =
{
	...
	},/* 18 1024x768x70Hz (LCD 1024x768x70Hz) */
	{
		Mode32Bpp + NoSupportHiVisionTV + SyncPP, RES1024x768x75, VCLK78_75,
		0x00, 0x47, 0x37, 1024, 768
	},/* 19 1024x768x75Hz (LCD 1024x768x75Hz) */
	{
	...
	},/*1f 1280x1024x60Hz (LCD 1280x1024x60Hz)*/
	{
		Mode32Bpp + NoSupportTV + SyncPP, RES1280x1024x75, VCLK135_5,
		0x00, 0x58, 0x3a, 1280, 1024
	},/*20 1280x1024x75Hz (LCD 1280x1024x75Hz)*/
	{
