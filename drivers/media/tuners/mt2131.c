...
static int mt2131_set_params(struct dvb_frontend *fe)
{
	...
	if (freq <=   82500) { if_band_center = 0x00; }
	else if (freq <=  137500) { if_band_center = 0x01; }
	else if (freq <=  192500) { if_band_center = 0x02; }
	else if (freq <=  247500) { if_band_center = 0x03; }
	else if (freq <=  302500) { if_band_center = 0x04; }
	else if (freq <=  357500) { if_band_center = 0x05; }
	else if (freq <=  412500) { if_band_center = 0x06; }
	else if (freq <=  467500) { if_band_center = 0x07; }
	else if (freq <=  522500) { if_band_center = 0x08; }
	else if (freq <=  577500) { if_band_center = 0x09; }
	else if (freq <=  632500) { if_band_center = 0x0A; }
	else if (freq <=  687500) { if_band_center = 0x0B; }
	else if (freq <=  742500) { if_band_center = 0x0C; }
	else if (freq <=  797500) { if_band_center = 0x0D; }
	else if (freq <=  852500) { if_band_center = 0x0E; }
	else if (freq <=  907500) { if_band_center = 0x0F; }
	else if (freq <=  962500) { if_band_center = 0x10; }
	else if (freq <= 1017500) { if_band_center = 0x11; }
	else if (freq <= 1072500) { if_band_center = 0x12; }
